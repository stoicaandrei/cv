...
<li>Secured funding of over $500k by building from scratch the MVP of a new centralized system by working closely with the client and understanding their needs. Also, fixed 90% of bugs by fixing the flaws in the existing system architecture.</li>
<li>Increased overall review scores by more than 150% and customer satisfaction by over 40% by improving user feedback process and solving their existing problems.</li>
</ul>
...
<ul class="list-disc pl-5">
<li>Built a successful MVP in less than 5 months by keeping a starling line of communication with the client and by efficiently managing a team to optimize all client needs inside the web app.</li>
<li>Increased company profit by over 60% and client's customer pool by more than 25% by continuously growing the product over the next year and by constantly releasing new, highly requested features.</li>
</ul>
...
<ul class="list-disc pl-5">
<li>Succeeded in pitching the project to over 10 media apparitions and talked to investors by taking part in a start-up accelerator by developing from scratch a fully tailored MVP in less than 4 months.</li>
<li>Achieved over 5K users in the app and website, with over 6K hours of learning tracked in the first year after the launch by consistently offering users sought after features and continuously improving the product.</li>
</ul>
